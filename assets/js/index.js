! function(n) {
    ...
    let o = 0;
    $("body").append(`<div id="fui-toast"></div><div class="td-lock-screen"><section class="td-welcome"><div class="medias"><video class="pc item_video" autoplay loop muted playsinline><source src="assets/video/pc.mp4?v=${c()}" type="video/mp4"></video><video class="mobile item_video" autoplay loop muted playsinline><source src="assets/video/mb1.mp4?v=${c()}" type="video/mp4"></video><div class="date"></div></div><div class="infos"><div class="logo-web-title"><img class="logo-ws" src="https://files.catbox.moe/9rcm0j.jpg" alt=" DOAN CONH SINH "><span class="web-title">${$("html").attr("data-title-loader") || "M\xe0n H\xecnh Kho\xe1"}</span></div><span class="web_desc"></span><div><i class="ri-arrow-down-line close-lockscreen"></i></div></div></section></div>`);
    ...
    function y() {
        $.ajax({
            url: "https://api.meliodas.info.vn/cham-ngon/", // Đảm bảo URL chính xác
            type: "GET",
            dataType: "json",
            success: function(response) {
                // Kiểm tra nếu trường `msg` tồn tại trong response
                if (response.msg) {
                    $("#cham-ngon").fadeOut(300, function() {
                        $(this).text(response.msg).fadeIn(300);
                    });
                } else {
                    console.error("Response does not contain 'msg':", response);
                }
            },
    ...
    let b = new class n {
        ...
        (["Gọi em l\xe0 c\xf4ng ch\xfaa v\xec ho\xe0ng tử đang đứng chờ em n\xe8!", "Chưa được sự cho ph\xe9p m\xe0 đ\xe3 tự \xfd th\xedch em, anh xin lỗi nh\xe9 c\xf4ng ch\xfaa!", "Em nh\xecn rất giống người họ h\xe0ng của anh, đ\xf3 ch\xednh l\xe0 con d\xe2u của mẹ anh!", "Tr\xe1i Đất quay quanh Mặt Trời, c\xf2n em th\xec quay m\xe3i trong t\xe2m tr\xed anh!", "Vector chỉ c\xf3 một chiều, anh d\xe2n chuy\xean to\xe1n chỉ y\xeau một người.", "Anh b\xe9o thế n\xe0y l\xe0 bởi v\xec trong l\xf2ng anh c\xf3 em nữa.", "Nghe đ\xe2y! Em đ\xe3 bị bắt v\xec tội qu\xe1 xinh đẹp.", "Anh chỉ muốn b\xean cạnh em hai lần đ\xf3 l\xe0 b\xe2y giờ v\xe0 m\xe3i m\xe3i.", "Bao nhi\xeau c\xe2n th\xednh cho vừa, bao nhi\xeau c\xe2n bả mới lừa được em?", "Vũ trụ của người ta l\xe0 m\xe0u đen huyền b\xed, c\xf2n vũ trụ của anh b\xe9 t\xed, thu nhỏ lại l\xe0 em.", "Anh rất y\xeau th\xe0nh phố n\xe0y, kh\xf4ng phải v\xec n\xf3 c\xf3 g\xec, m\xe0 v\xec n\xf3 c\xf3 em.", "Anh bận với tất cả mọi điều, nhưng vẫn lu\xf4n rảnh để nhớ đến em.", "C\xe0nh c\xe2y c\xf2n c\xf3 l\xe1. Ch\xfa c\xe1 vẫn đang bơi, sao em cứ mải chơi. Chẳng chịu y\xeau anh thế!", "Em nh\xe0 ở đ\xe2u thế? Cứ tới lui trong tim anh kh\xf4ng biết đường về nh\xe0 \xe0?", "Cuộc đời anh vốn l\xe0 một đường thẳng, chỉ v\xec gặp em m\xe0 rẽ ngang.", "Với thế giới em chỉ l\xe0 một người, nhưng với anh, em l\xe0 cả thế giới.", "Em c\xf3 thể đừng cười nữa được kh\xf4ng, da anh đen hết rồi.", "Anh đ\xe2y chẳng th\xedch nhiều lời, nh\xecn em l\xe0 biết cả đời của anh.", "Cảm lạnh c\xf3 thể do gi\xf3, nhưng, cảm nắng th\xec chắc chắn do em.", "Trứng r\xe1n cần mỡ, bắp cần bơ, y\xeau kh\xf4ng cần cớ, cần em cơ!", "Cafe đắng th\xeam đường sẽ ngọt, c\xf2n cuộc đời anh th\xeam em sẽ hạnh ph\xfac.", "Giữa cuộc đời h\xe0ng ng\xe0n c\xe1m dỗ, nhưng, anh vẫn chỉ cần bến đỗ l\xe0 em.", "C\xf3 người rủ anh đi ăn tối, nhưng anh từ chối v\xec thực đơn kh\xf4ng c\xf3 em.", "Em c\xf3 biết v\xec sao đầu tuần lại bắt đầu bằng thứ hai kh\xf4ng, bởi v\xec em l\xe0 thứ nhất!", "Oxy l\xe0 nguồn sống của nh\xe2n loại, c\xf2n em ch\xednh l\xe0 nguồn sống của anh.", "Em bị cận thị \xe0? Nếu kh\xf4ng tại sao kh\xf4ng nh\xecn thấy anh th\xedch em chứ?", "H\xf4m qua anh gặp \xe1c mộng v\xec trong giấc mộng đ\xf3 kh\xf4ng c\xf3 em.", "Uống nhầm một \xe1nh mắt, cơn say theo cả đời, thương nhầm một nụ cười, cả một đời phi\xeau l\xe3ng.", "Dạo n\xe0y em c\xf3 thấy mỏi ch\xe2n kh\xf4ng, sao cứ đi m\xe3i trong đầu anh thế?", "H\xecnh như em th\xedch tr\xe0 sữa lắm phải kh\xf4ng, anh cũng th\xedch em như thế đấy.", "Nếu em l\xe0 nước mắt th\xec anh sẽ kh\xf4ng bao giờ kh\xf3c để lạc mất em đ\xe2u.", "Đ\xf4i mắt em c\xf2n xanh hơn cả Đại T\xe2y Dương v\xe0 anh th\xec bị lạc tr\xean biển cả mất rồi.", "Nếu nụ h\xf4n l\xe0 những b\xf4ng tuyết th\xec anh sẽ gửi đến em một cơn b\xe3o tuyết", "Phải chăng em l\xe0 một ảo thuật gia, bởi mỗi khi anh nh\xecn em l\xe0 mọi thứ xung quanh đều biến mất.", "Anh c\xf3 thể chụp ảnh em được kh\xf4ng, để chứng minh với lũ bạn rằng thi\xean thần l\xe0 c\xf3 thật.", "Anh c\xf3 thể đi theo em được kh\xf4ng, bởi anh được bố mẹ dạy rằng phải theo đuổi giấc mơ của m\xecnh.", "Nếu khi anh nghĩ đến em m\xe0 c\xf3 một ng\xf4i sao biến mất, vậy chắc cả bầu trời n\xe0y kh\xf4ng c\xf2n sao.", ]);
    ...
    $(window).on("load", () => {
        ...
        console.log("cngsinhface", "color:#fff;background:linear-gradient(90deg,#448bff,#44e9ff);padding:5px 0;", "color:#000;background:linear-gradient(90deg,#44e9ff,#ffffff);padding:5px 10px 5px 0px;");
    var _, C, T = new Image;
    ...
    sakura = "//i.ibb.co/nbW2BwJ/hongson.png",
        leaf = "//i.ibb.co/nbW2BwJ/hongson.png",
        maple = "//i.ibb.co/nbW2BwJ/hongson.png",
        user = "",
        T.src = maple,
